        ...
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
            <div className="container-fluid">
                ...
                <form className="d-flex" role="search">
                    ...
                    <button className={`btn btn-${props.mode==="white"?"dark":"white"} bg-${props.mode==="dark"?"light":"dark"}`} type="submit">Search</button>
                </form>
                <div className={`form-check form-switch mx-3 text-${props.mode==="white"?"dark":"light"}`}>
